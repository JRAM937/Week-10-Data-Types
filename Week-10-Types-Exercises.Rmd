...
> The code snippet will create a variable "weekday" that garbs every time for every day of the week, then drop any undefined/unplotted values, and finally create a summary of how many delays happen per day on average.Based on the analysis of the result, the best day to fly is Saturday because there are less delays reported compared to other days.
